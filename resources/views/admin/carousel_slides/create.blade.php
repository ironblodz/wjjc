...
<div class="w-full space-y-8">
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
        <div class="flex items-center">
            ...
            <div>
                ...
                <p class="text-lg text-gray-600">Adicione um novo slide ao carrossel principal do site</p>
            </div>
        </div>
    </div>
    <!-- Form Card -->
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
        ...
        <form action="{{ route('backoffice.admin.carousel-slides.store') }}" method="POST" enctype="multipart/form-data" class="p-8" novalidate>
            @csrf
            <div class="space-y-8">
                <div class="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-6 border border-blue-100">
                    ...
                    <input type="text" name="title" id="title" class="w-full px-6 py-4 text-lg border-2 border-gray-300 rounded-xl focus:ring-4 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 shadow-sm" required maxlength="255">
                </div>
                <div class="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-6 border border-green-100">
                    ...
                    <input type="text" name="link" id="link" class="w-full px-6 py-4 text-lg border-2 border-gray-300 rounded-xl focus:ring-4 focus:ring-green-500 focus:border-green-500 transition-all duration-300 shadow-sm" required maxlength="255">
                </div>
                <div class="bg-gradient-to-r from-orange-50 to-yellow-50 rounded-2xl p-6 border border-orange-100">
                    ...
                    <input type="number" name="order" id="order" class="w-full px-6 py-4 text-lg border-2 border-gray-300 rounded-xl focus:ring-4 focus:ring-orange-500 focus:border-orange-500 transition-all duration-300 shadow-sm" value="0">
                </div>
                <div class="bg-gradient-to-r from-indigo-50 to-blue-50 rounded-2xl p-6 border border-indigo-100 flex items-center">
                    <input type="checkbox" name="active" id="active" class="form-check-input mr-3" checked value="1">
                ...
                <div class="bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl p-6 border border-purple-100">
                    <label for="image" class="block text-lg font-semibold text-gray-900 mb-4">
                        ...
                        Imagem <span class="text-red-500" aria-label="Campo obrigatório">*</span>
                    </label>
                    <input type="file" name="image" id="image" class="w-full px-6 py-4 text-lg border-2 border-gray-300 rounded-xl focus:ring-4 focus:ring-purple-500 focus:border-purple-500 transition-all duration-300 shadow-sm" required>
                </div>
            </div>
