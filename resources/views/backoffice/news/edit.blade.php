...
<div class="w-full space-y-8">
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
        <div class="flex items-center">
            ...
            <div>
                ...
                <p class="text-lg text-gray-600">Altere as informações da notícia</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
        ...
        <form action="{{ route('backoffice.admin.news.update', $news) }}" method="POST" enctype="multipart/form-data" class="p-8 space-y-8" novalidate>
            @csrf
            @method('PUT')
            <!-- Título -->
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-100">
                    ...
                    <input type="date" name="start_date" id="start_date" value="{{ old('start_date', $news->start_date ? \Carbon\Carbon::parse($news->start_date)->format('Y-m-d') : '') }}"
                ...
                <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-100">
                    ...
                    <input type="date" name="end_date" id="end_date" value="{{ old('end_date', $news->end_date ? \Carbon\Carbon::parse($news->end_date)->format('Y-m-d') : '') }}"
            ...
            <div class="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-6 border border-green-100">
                ...
                @if($news->image)
                    <div class="mb-4">
                        <img src="{{ asset('storage/' . $news->image) }}" alt="imagem" class="w-32 h-32 object-cover rounded-xl border">
                    </div>
                @endif
