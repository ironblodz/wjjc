...
@section('title', trans('backoffice.partnerships.create'))
...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
            ...
            <div class="flex justify-between items-center py-6">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">
                        ...
                        {{ trans('backoffice.partnerships.create') }}
                    </h1>
                    <p class="mt-2 text-sm text-gray-600">
                        Adicione uma nova parceria ao WJJC
                    </p>
                </div>
                <div>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            <form action="{{ route('backoffice.admin.partnerships.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="mb-8">
                        ...
                        <div class="mt-6">
                            ...
                            <textarea name="description"
                                      ...
                                      placeholder="Descrição da parceria">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    <label for="logo" class="cursor-pointer">
                                        <span class="text-lg font-medium text-gray-900">Clique para selecionar um logo</span>
