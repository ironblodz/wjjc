...
// Expansão de submenu no mobile ao clicar na seta
$(document).on("click", ".submenu-toggle", function (e) {
    e.preventDefault();
    var parentLi = $(this).closest("li");
    if (parentLi.hasClass("show")) {
        parentLi.removeClass("show");
        parentLi.children("ul").slideUp(500);
    } else {
        parentLi.siblings("li").removeClass("show");
        parentLi.addClass("show");
        parentLi.siblings("li").find("ul").slideUp(500);
        parentLi.children("ul").slideDown(500);
    }
});
